...
namespace NHH.Models.Project
{
    ...
    public class ProjectInfo
    {
        ...
        /// 业主公司列表
        /// </summary>
        public List<ProjectOwnerInfo> OwnerList { get; set; }
        ...
        public List<string> RenderingFileList
        {
            get
            {
                if (string.IsNullOrEmpty(RenderingFileName) || RenderingFileName.Length == 0)
                    return new List<string>();
                return RenderingFileName.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries).ToList();
            }
        }
