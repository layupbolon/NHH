<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampaignDetail.aspx.cs" Inherits="NHH.WebSite.Official.CampaignDetail" %>
...
<head>
    <meta charset="utf-8" />
    <meta name="description" content="立天唐人商业NHHCG.COM-热门活动_唐人中心周年庆_开业狂欢_大型活动" />
    <title>上海立天唐人商业集团有限公司 - 活动中心</title>
...
<body>
    ...
    <head:head ID="head" runat="server" CurrentMenu="活动中心" />

    <div id="main">
        <div class="wraper">
            <section id="profile-comnent" class="profile-content bgWhite" style="margin-top: 80px;">
                <div class="coment details">
                    <%=service.GetCampaignContent(pageID) %>
                </div>
            </section>
        </div>
    </div>
