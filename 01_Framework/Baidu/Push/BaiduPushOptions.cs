...
namespace NHH.Framework.Baidu.Push
{
    public class BaiduPushOptions
    {
        ...
        public BaiduPushOptions(string user_id, string channel_id)
        {
        ...
        public BaiduPushOptions(string user_id, string channel_id, string messages)
        {
            this.user_id = user_id;
            this.channel_id = channel_id;
            this.push_type = 1;
